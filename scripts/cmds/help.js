...
module.exports = {
 ...
 name: "help",
 version: "1.18",
 author: "NTKhang | Arafat | Viết Công",
 countDown: 5,
 role: 0,
 shortDescription: {
 vi: "Xem cách sử dụng lệnh",
 ...
 + "\n {pn} <tên lệnh> [-u | usage | -g | guide]: chỉ hiển thị cách sử dụng lệnh"
 + "\n {pn} <tên lệnh> [-i | info]: chỉ hiển thị thông tin lệnh"
 + "\n {pn} <tên lệnh> [-r | role]: chỉ hiển thị quyền hạn lệnh"
 + "\n {pn} <tên lệnh> [-a | alias]: chỉ hiển thị tên gọi khác của lệnh",
 ...
 + "\n✪──────⦿"
 + "\n✪ Trang [ %2/%3 ]"
 + "\n│ 𝐇𝐢𝐞̣̂𝐧 𝐭𝐚̣𝐢, 𝐁𝐨𝐭 𝐂𝐨́ %4 𝐋𝐞̣̂𝐧𝐡 𝐂𝐨́ 𝐓𝐡𝐞̂̉ 𝐒𝐮̛̉ 𝐃𝐮̣𝐧𝐠"
 + "\n│ 𝐆𝐨̃ %5𝐡𝐞𝐥𝐩 <𝐬𝐨̂́ 𝐭𝐫𝐚𝐧𝐠> 𝐃𝐞̂̉ 𝐗𝐞𝐦 𝐃𝐚𝐧𝐡 𝐒𝐚́𝐜𝐡 𝐋𝐞̣̂𝐧𝐡"
 + "\n│ 𝐆𝐨̃ %5𝐡𝐞𝐥𝐩 <𝐭𝐞̂𝐧 𝐥𝐞̣̂𝐧𝐡> 𝐃𝐞̂̉ 𝐗𝐞𝐦 𝐂𝐡𝐢 𝐓𝐢𝐞̂́𝐭 𝐂𝐚́𝐜𝐡 𝐒𝐮̛̉ 𝐃𝐮̣𝐧𝐠"
 + "\n✪──────⦿"
 + "\n✪ %6"
 + "\n╰─────────────⦿",
 help2: "%1╭──────────⦿"
 + "\n│ 𝐓𝐨̂̉𝐧𝐠 𝐬𝐨̂́ 𝐥𝐞̣̂𝐧𝐡:「%2」"
 + "\n╰─────────────⦿\n╭─────────────⦿\n│%4\n╰────────────⦿",

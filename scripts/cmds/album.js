...
module.exports = { 
  config: { 
    ...
    category: "media",
    description: {
      vi: "Xem và quản lý album video",
      en: "View and manage video albums"
    },
    guide: { 
      vi: "{pn} [số trang] - Xem danh sách album\n{pn} add [danh mục] [URL] - Thêm video vào danh mục\n{pn} list - Xem tổng số video trong mỗi danh mục",
      en: "{pn} [page number] - View album list\n{pn} add [category] [URL] - Add a video to a category\n{pn} list - View total videos in each category",
    }, 
  },
  ...
  onStart: async function ({ api, event, args }) { 
   ...
   ["funny", "islamic", "sad", "anime", "lofi", "attitude", "horny", "couple",
      "car", "bike", "love", "lyrics", "cat", "18+", "freefire",
      "football", "baby", "friend", "pubg", "flower", "naruto", "dragon", "bleach", "demon", "jjk", "solo", "tokyo", "bluelock", "cman", "deathnote", "onepiece", "attack", "sakamoto", "wind", "onepman", "alya", "bluebox", "hunter", "loner", "hanime", "neymar", "messi", "ronaldo", "vini", "mbappe", "yamal", "rapinha", "dybala", "pele", "maradona","white", "ruok", "b2k", "bnl", "vincenzo", "syblus", "raistar", "smooth", "astatine", "teamexe"],
            captions: [

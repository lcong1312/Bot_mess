...
module.exports = {
  config: {
    ...
    category: "love",
    description: {
      vi: "Lấy caption ngẫu nhiên theo chủ đề",
      en: "Get random caption by category"
    },
    guide: {
      vi: "{pn} [chủ đề] - Lấy caption\n{pn} list - Xem danh sách chủ đề\n{pn} add [chủ đề] [ngôn ngữ] [nội dung] - Thêm caption",
      en: "{pn} [category] - Get caption\n{pn} list - View categories\n{pn} add [category] [language] [text] - Add caption"
    }
  },

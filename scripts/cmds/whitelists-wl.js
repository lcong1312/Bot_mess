...
module.exports = {
	config: {
		...
		role: 1,
		description: {
			vi: "Thêm, xóa, chỉnh sửa danh sách người dùng được phép dùng bot",
			en: "Add, remove, edit whiteListIds role"
		},
		category: "admin",
		guide: {
			vi: '   {pn} [add | -a] <uid | @tag>: Thêm người dùng vào danh sách được phép'
				+ '\n	  {pn} [remove | -r] <uid | @tag>: Xóa người dùng khỏi danh sách được phép'
				+ '\n	  {pn} [list | -l]: Xem danh sách tất cả người dùng được phép'
				+ "   {pn} -m [on | off]: Bật/tắt chế độ chỉ người trong danh sách mới dùng được bot"
				+ "\n {pn} -m noti [on | off]: Bật/tắt thông báo khi người dùng không trong danh sách dùng bot",
	...
	langs: {
		vi: {
			...
			alreadyAdmin: `\n╭✦⚠️ | Đã có %1 người dùng trong danh sách\n%2`,
			missingAdd: "⚠️ | Vui lòng nhập UID để thêm vào danh sách được phép",
			removed: `╭✦✅ | Đã xóa %1 người dùng\n%2`,
			notAdmin: `╭✦⚠️ | Chưa thêm %1 người dùng\n%2`,
			missingIdRemove: "⚠️ | Vui lòng nhập UID để xóa khỏi danh sách được phép",
			listAdmin: `╭✦✨ | Danh sách người dùng được phép\n%1\n╰───────────────────⧕`,
			turnedOn: "✅ | Đã bật chế độ chỉ người trong danh sách mới dùng được bot",
			turnedOff: "❎ | Đã tắt chế độ chỉ người trong danh sách mới dùng được bot",
			turnedOnNoti: "✅ | Đã bật thông báo khi người dùng không trong danh sách dùng bot",
			turnedOffNoti: "❎ | Đã tắt thông báo khi người dùng không trong danh sách dùng bot"
		},
		en: {

...
module.exports = {
  config: {
    name: "car",
    aliases: ["carvideo", "carvid"],
    version: "1.7",
    role: 0,
    author: "MahMUD | Viết Công",
    category: "media",
    description: {
      vi: "Lấy video xe hơi ngẫu nhiên",
      en: "Get random car video"
    },
    guide: {
      vi: "Dùng {pn} để lấy video xe hơi ngẫu nhiên.",
      en: "Use {pn} to get a random car video."
    }
  },
  ...
  langs: {
    vi: {
      ...
      hereVideo: "Đây là video xe hơi của bạn 😘",
      downloadError: "❌ | Lỗi tải xuống.",
      error: "🥹 Đã xảy ra lỗi, vui lòng thử lại."
    },
    en: {
      noVideos: "❌ | No videos found.",
      hereVideo: "Here's your car video 😘",
  ...
  onStart: async function ({ api, event, getLang }) {
    ...
    try {
      ...
      const res = await axios.get(`${apiUrl}/api/album/videos/car?userID=${event.senderID}`);
